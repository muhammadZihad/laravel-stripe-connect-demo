                ...
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p class="text-gray-600">Add a new way to receive payments</p>
                        </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="mt-1 text-sm text-blue-700">
                                    Payment methods are securely processed through Stripe. Use test card numbers for demo
                                    purposes (4242424242424242).
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <form id="payment-method-form">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="billing_name" class="block text-sm font-medium text-gray-700">Full
                                        Name</label>
                            ...
                            <div class="mt-4">
                                <label for="billing_phone" class="block text-sm font-medium text-gray-700">Phone Number
                                    (Optional)</label>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <label class="relative">
                                    <input type="radio" name="type" value="financial_connections" class="sr-only peer"
                                        checked>
                                    <div
                                        class="flex items-center p-4 border-2 border-green-200 bg-green-50 rounded-lg cursor-pointer peer-checked:border-green-500 peer-checked:bg-green-100">
                                        <div
                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-center">
                                                <div class="text-sm font-medium text-gray-900">🏦 Connect with Your Bank
                                                </div>
                                                <span
                                            ...
                                            <div class="text-sm text-gray-600 mt-1">Connect securely via online banking -
                                                instant verification</div>
                                            <div class="text-xs text-green-600 mt-1">✓ Instant • No manual entry • Secure
                                            </div>
                                        </div>
                                    </div>
                                </label>
                                ...
                                <label class="relative">
                                    ...
                                    <div
                                        class="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer peer-checked:border-primary-500 peer-checked:bg-primary-50">
                                ...
                                <label class="relative">
                                    ...
                                    <div
                                        class="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer peer-checked:border-primary-500 peer-checked:bg-primary-50">
                                        <div
                                            class="flex items-center justify-center w-10 h-10 bg-yellow-100 rounded-lg mr-3">
                                        ...
                                        <div class="flex-1">
                                            <div class="text-sm font-medium text-gray-900">📝 Add Bank Account Manually
                                            </div>
                                            <div class="text-sm text-gray-500">Enter routing & account numbers</div>
                                            <div class="text-xs text-yellow-600 mt-1">⚠️ Requires verification (1-2 business
                                                days)</div>
                                        </div>
                                    </div>
                                </label>
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="mt-1 text-sm text-blue-700">
                                            <p>Connect your bank account securely through your online banking. No need to
                                                enter sensitive account details manually.</p>
                        ...
                        <div id="bank-section" class="space-y-4" style="display: none;">
                            <div>
                                ...
                                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
                                    <p class="text-sm text-yellow-700">
                                        <strong>Note:</strong> For this demo, we'll collect bank details manually. In
                                        production, you would integrate with Stripe's ACH verification process.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div id="manual-bank-info">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label for="routing_number" class="block text-sm font-medium text-gray-700">Routing
                                            Number</label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                    <div>
                                        <label for="account_holder_type"
                                            class="block text-sm font-medium text-gray-700">Account Holder Type</label>
                        ...
                        <div class="mt-6">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Your default payment method will be used for all new
                                payments.</p>
                        </div>
                        ...
                        <div class="mt-8 flex items-center justify-between">
                            ...
                            <div class="flex gap-3">
                                ...
                                <button type="submit" id="submit-button"
                                    class="bg-primary-600 hover:bg-primary-700 text-white px-6 py-2 rounded-md text-sm font-medium disabled:opacity-50"
                                    disabled>
            ...
            form.addEventListener('submit', async (event) => {
                ...
                try {
                    ...
                    if (selectedType === 'financial_connections') {
                        ...
                        // Use SetupIntent flow for off-session 3DS authentication
                        // Step 1: Get SetupIntent from backend
                        const setupResponse = await fetch('{{ route('agent.payment-methods.create-card-setup-intent') }}', {
                            method: 'POST',
                            headers: {
                        ...
                        // Step 2: Confirm card setup (this triggers 3DS popup if required)
                        ...
                        if (error) {
                            // Show error to customer (e.g., 3DS failed or card declined)
                        ...
                        // Step 3: SetupIntent succeeded, save to backend
                        const confirmResponse = await fetch('{{ route('agent.payment-methods.confirm-card-setup') }}', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                        ...
                        if (confirmData.success) {
                            alert('✅ Card added successfully with 3D Secure verification!');
                            window.location.href = '{{ route('agent.payment-methods') }}';
                        } else {
                            document.getElementById('card-errors').textContent = confirmData.error || 'Failed to save card';
                            submitButton.disabled = false;
                            buttonText.classList.remove('hidden');
                            spinner.classList.add('hidden');
                        }
                    ...
                    if (result.error) {
                        ...
                        const response = await fetch('{{ route('agent.payment-methods.store') }}', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),

    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow rounded-lg mb-6 p-4">
                <form method="GET" action="{{ route('company.invoices') }}" class="flex flex-wrap gap-4 items-end">
                    <!-- Agent Filter -->
                    ...
                    <div class="flex gap-2">
                        ...
                        @if(request('agent_id') || request('status'))
                                ...
                                <div class="px-4 py-4 flex items-center justify-between">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0">
                                            <div
                                                class="w-10 h-10 {{ $invoice->status === 'paid' ? 'bg-green-100' : ($invoice->isOverdue() ? 'bg-red-100' : 'bg-yellow-100') }} rounded-full flex items-center justify-center">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <div class="flex items-center mt-2 space-x-2">
                                            ...
                                            @if($invoice->status !== 'paid')
                                                <a href="{{ route('company.invoices.edit', $invoice) }}"

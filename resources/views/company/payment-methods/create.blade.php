                ...
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex gap-3">
                            <a href="{{ route('company.payment-methods') }}"
            ...
            form.addEventListener('submit', async (event) => {
                ...
                try {
                    ...
                    if (selectedType === 'financial_connections') {
                        ...
                        const setupResponse = await fetch('{{ route('company.payment-methods.create-card-setup-intent') }}', {
                            method: 'POST',
                            headers: {
                        ...
                        const confirmResponse = await fetch('{{ route('company.payment-methods.confirm-card-setup') }}', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),

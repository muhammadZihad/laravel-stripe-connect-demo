            ...
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="text-sm text-gray-500">
                        Total Commission Earned: ${{ number_format($totalCommission ?? 0, 2) }}
                    </div>
                </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($transactions as $transaction)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">{{ $transaction->agent->user->name }}</div>
                                            <div class="text-sm text-gray-500">{{ $transaction->agent->agent_code }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">${{ number_format($transaction->amount, 2) }}</div>
                                            <div class="text-sm text-gray-500">Net: ${{ number_format($transaction->net_amount, 2) }}</div>
                                        </td>
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <p class="text-gray-500 mb-4">Transactions will appear here when invoices are paid.</p>
                    </div>
                @endif
            </div>
        </div>

    ...
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('super_admin.agents.show', $agent) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-md text-sm font-medium">
                    ← Back to Agent
                </a>
            </div>
        </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('super_admin.agents.update', $agent) }}" method="POST" class="space-y-6 p-6">
                @csrf
                @method('PUT')
                ...
                <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                    <a href="{{ route('super_admin.agents.show', $agent) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-md text-sm font-medium">
                        Cancel
                    </a>
